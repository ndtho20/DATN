...
*/
    ...
    function nc(a) {
        var b = {timeout: 3E4, attributes: {async: !1, defer: !1}}, c = b.document || document, d = Ka(a).toString(),
            e = vb((new wb(c)).g, "SCRIPT"), h = {L: e, M: void 0}, f = new U(jc, h), g = null,
...
*/
    ...
    function Gc(a, b, c) {
        ...
        var d = c.libraries, e = function (g) {
            ...
            return g.split("=")
        }) : []), h = Object.assign({}, {key: a, W: d}, e), f = "2" === b ? Fc : Ec;
    ...
    if (sc) console.warn("Google Charts loader.js should only be loaded once."); else {
        ...
        var Nc = document.getElementsByTagName("script"),
            Oc = (document.currentScript || Nc[Nc.length - 1]).getAttribute("src"), Pc = new L(Oc), Qc = Pc.g;
        sc = Qc = Qc.match(/^www\.gstatic\.cn/) ? "gstatic.cn" : "gstatic.com";
        var Rc = new N(Pc.i.toString()), Sc = Rc.get("callback");
        if ("string" === typeof Sc) {
            var Tc = Bc(Sc);
            pc().then(Tc)
        }
